...
class MultimediaApplication : MApplication() {
    ...
    private var mMultimediaBroadcastReceiver: MultimediaBroadcastReceiver? = null
    override fun onCreate() {
        super.onCreate()
        MMLog.d("MultimediaApplication", "MultimediaApplication onCreate!")
        Mavericks.initialize(this)
        //////////////////////////////////////////////////////////////////////////////////
        mMultimediaBroadcastReceiver = MultimediaBroadcastReceiver()
        registerBaseBroadcastReceiver(this)
        startService(Intent(this, MultimediaService::class.java))
    ...
    private fun registerBaseBroadcastReceiver(context: Context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            context.registerReceiver(mMultimediaBroadcastReceiver, intentFilter, MultimediaBroadcastReceiver.Action_OCTOPUS_permission, null, RECEIVER_EXPORTED)
        }
    }
